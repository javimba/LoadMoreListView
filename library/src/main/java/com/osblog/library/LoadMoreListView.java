...
public class LoadMoreListView extends ListView implements OnScrollListener {
    ...
    private void init(Context context) {
        ...
        View footerView = LayoutInflater.from(context).inflate(R.layout.load_more_footer, null);
        loadMoreLayout = (LinearLayout) footerView.findViewById(R.id.load_more_layout);
